                        ...
                        <div class="widget-boxed-body">
                           <div class="recent-post">
                              ...
                              <div class="recent-main my-4">
                                 ...
                                 <div class="info-img">
                                    <a href="{{url('get_property')}}/{{$latist->id}}">
                                       <h6>{{ucfirst($latist->pro_title)}}</h6>
                                    </a>
                                    <p>&#8377; {{$latist->price}}</p>
                                 </div>
                              </div>
...
<script>
   if ($('#map-contact').length) {
   		var map = L.map('map-contact', {
   			...
   			center: ['{{$pro->google_map_lat}}', '{{$pro->google_map_log}}']
   		});
   		...
   		var marker = L.marker(['{{$pro->google_map_lat}}', '{{$pro->google_map_log}}'], {
   			icon: icon
   		}).addTo(map);
   	}
