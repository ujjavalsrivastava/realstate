   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <p>Company provides a number of internet-based services through its platform and shall </p>
            <br>
            <p> 1. Posting User profile or listing for the purpose of sale/rental of property, and related property services </p>
            <br>
            <p> 2. Fnid aproperty througAlpha Land.com and its internet links.</p>
            <br>
            <p> 3. Place a print advertisement in any of the group publications through the A l p h a Land. .com site.</p>
            <br>
            <p> 4. Post advertisements on Alpha Land.com </p>
            <br>
            <p> 5. Send advertisements and promotional messages through emails and messages.</p>
            <br>
         ...
         <div class="col-lg-6 col-md-12 col-xs-12">
            ...
            <p> 1. To provide accurate, complete and correct registration data on initial application for the Services.</p>
            <br>
            <p> 2. The User agrees that any data entered on the Site will be subject to mandatory verification process by the Company.</p>
            <br>
            <p> 3. Any and all licenses, permits, consents, approvals and intellectual property or other rights as may be required for using the Service shall be obtained by the User at his own cost.</p>
            <br>
            <p> 4. The User will ensure compliance with all notices or instructions given by the Company from time to time to enable the use of the Service. </p>
            <br>
            <p> 5. The User understands and agrees that the User is responsible for all applicable taxes and for all costs that are incurred in using the Site service(s).</p>
            <br>
